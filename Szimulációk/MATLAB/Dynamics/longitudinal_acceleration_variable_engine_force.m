...
% Define the engine traction force [N]

% F_engine = 4000 + 500 * square(0.1 * t);

A = 500;
delta = 0.1;
f = 0.05;
F_engine = 4000 + (A/atan(1/delta))*atan(sin(2*pi*t*f - pi / 2)/delta);
...
plot(t, F_engine, "k-", "LineWidth", 2.0, "DisplayName", "F_{engine}");
